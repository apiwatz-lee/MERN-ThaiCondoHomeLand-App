  ...
  return (
    <>
      {products.length > 0 ? (
        ...
        <section className='w-full pt-10 px-5 flex justify-center items-center text-2xl xl:text-4xl text-slate-800 font-bold'>
          <p className='text-center'>
            😩 Sorry, no assets were found based on your specified filters
          </p>
        </section>
      )}
    </>
